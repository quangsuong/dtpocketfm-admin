            ...
            <div class="border-bottom row mb-3">
                <div class="col-sm-10">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="{{ route('anovel.episode.index', $novel_id) }}">Chapters</a></li>
                        <li class="breadcrumb-item active" aria-current="page">Add Chapter</li>
                    </ol>
                </div>
                <div class="col-sm-2 d-flex align-items-center justify-content-end">
                    <a href="{{ route('anovel.episode.index', $novel_id) }}" class="btn btn-default mw-120" style="margin-top:-14px">Chapters List</a>
                </div>
            </div>
