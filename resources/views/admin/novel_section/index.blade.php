...
@section('page_title', 'Novel Section')
...
@section('content')
    ...
    <div class="right-content">
        ...
        <div class="body-content">
            <!-- mobile title -->
            <h1 class="page-title-sm">Novel Section</h1>

            <div class="border-bottom row mb-3">
                <div class="col-sm-11">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="{{ route('admin.dashboard') }}">{{__('Label.Dashboard')}}</a></li>
                        <li class="breadcrumb-item active" aria-current="page">Novel Section</li>
                    </ol>
                </div>
    ...
    <script>
            ...
            if(Check_Admin == 1){
                ...
                $.ajax({
                    ...
                    success:function(resp){
                        $("#dvloader").hide();
                        get_responce_message(resp, 'save_content_section', '{{ route("sectionnovel.index") }}');
                    },
        ...
        if(Is_home_screen == 1) {
            $.ajax({
                ...
                type: 'POST',
                url: '{{ route("sectionnovel.content.data") }}',
                data: {
        ...
        function edit_section(id){
            ...
            $.ajax({
                ...
                type: 'POST',
                url: '{{ route("sectionnovel.content.edit") }}',
                data: {
                    id: id,
                },
                success: function(resp) {
        ...
        function update_section(){
            ...
            if(Check_Admin == 1){
                ...
                var url = '{{ route("sectionnovel.update", ":id") }}';
                ...
                $.ajax({
                    ...
                    success: function(resp) {
                        ...
                        get_responce_message(resp, 'edit_content_section', '{{ route("sectionnovel.index") }}');
                    },
                    error: function(XMLHttpRequest, textStatus, errorThrown) {
                        $("#dvloader").hide();
                        toastr.error(errorThrown.msg, 'failed');
        ...
        function delete_section(id){
            ...
            if(Check_Admin == 1){
                ...
                if(result){
                    ...
                    var url = '{{ route("sectionnovel.show", ":id") }}';
                        url = url.replace(':id', id);
                    ...
                    $.ajax({
                        ...
                        success: function(resp) {
                            $("#dvloader").hide();
                            get_responce_message(resp, '', '{{ route("sectionnovel.index") }}');
                        },
                        error: function(XMLHttpRequest, textStatus, errorThrown) {
                            $("#dvloader").hide();
                            toastr.error(errorThrown.msg, 'failed');
        ...
        function sortableBTN(){
            ...
            $.ajax({
                ...
                type: 'POST',
                url: '{{ route("sectionnovel.content.sortable") }}',
                data: {
                    is_home_screen: Is_home_screen,
        ...
        function save_section_sortable() {
            ...
            if(Check_Admin == 1){
                ...
                $.ajax({
                    type: 'POST',
                    url: '{{ route("sectionnovel.content.sortable.save") }}',
                    data: formData,
                    cache: false,
                    contentType: false,
                    processData: false,
                    success: function(resp) {
                        $("#dvloader").hide();
                        get_responce_message(resp, 'save_section_sortable', '{{ route("sectionnovel.index") }}');
                    },
                    error: function(XMLHttpRequest, textStatus, errorThrown) {
                        $("#dvloader").hide();
                        toastr.error(errorThrown.msg, 'failed');
