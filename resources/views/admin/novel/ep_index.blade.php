...
@section('content')
    ...
    <div class="right-content">
        ...
        <div class="body-content">
            ...
            <!-- Search -->
            <form action="{{ route('novel.episode.index', $novel_id)}}" method="GET">
            ...
            <div class="row">
                <div class="col-12 col-sm-6 col-md-4 col-xl-3">
                    <a href="{{ route('novel.episode.add', $novel_id) }}" class="add-video-btn">
                        ...
                        <div class="position-relative">
                            ...
                            <ul class="list-inline overlap-control" aria-labelledby="dropdownMenuLink">
                                <li class="list-inline-item">
                                    <a class="btn" href="{{route('novel.episode.edit', [$novel_id, $value->id])}}" title="Edit">
                                        <i class="fa-solid fa-pen-to-square fa-xl" class="dot-icon" style="color: #4e45b8;"></i>
                                    </a>
                                </li>
                                <li class="list-inline-item">
                                    <a class="btn" href="{{route('novel.episode.delete', [$novel_id, $value->id])}}" title="Delete" onclick="return confirm('Are you sure !!! You want to Delete this Chapter ?')">
    ...
    <script>
        ...
        function save_episode_sortable() {
            ...
            if(Check_Admin == 1){
                ...
                $.ajax({
                    type: 'POST',
                    url: '{{ route("novel.episode.sortable") }}',
                    data: formData,
                    cache: false,
                    contentType: false,
                    processData: false,
                    success: function(resp) {
                        $("#dvloader").hide();
                        get_responce_message(resp, 'save_episode_sortable', '{{ route("novel.episode.index", $novel_id)}}');
                    },
