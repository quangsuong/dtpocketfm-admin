            ...
            <div class="border-bottom row mb-3">
                <div class="col-sm-10">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="{{ route('novel.episode.index', $novel_id) }}">Episodes</a></li>
                        <li class="breadcrumb-item active" aria-current="page">Add Episode</li>
                    </ol>
                </div>
                <div class="col-sm-2 d-flex align-items-center justify-content-end">
                    <a href="{{ route('novel.episode.index', $novel_id) }}" class="btn btn-default mw-120" style="margin-top:-14px">Episodes List</a>
                </div>
            </div>
        ...
        function save_episode() {
            ...
            if (Check_Admin == 1) {
                ...
                $.ajax({
                    ...
                    type: 'POST',
                    url: '{{route("novel.episode.update", [$novel_id, $data->id])}}',
                    data: formData,
                    cache: false,
                    contentType: false,
                    processData: false,
