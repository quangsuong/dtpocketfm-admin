            ...
            <div class="card custom-border-card mt-3">
                <div class="page-search mb-3">
                    <div class="input-group" title="Search">
                        ...
                        <input type="text" id="input_search" class="form-control" placeholder="Search Language" aria-label="Search" aria-describedby="basic-addon1">
                    </div>
                </div>
                    ...
                    <div class="modal-content">
                        ...
                        <form id="edit_language" autocomplete="off">
                            ...
                            <div class="modal-footer">
                                <button type="button" class="btn btn-default mw-120" onclick="update_language()">Update</button>
    ...
    <script>
        ...
        function update_language() {
            ...
            if (Check_Admin == 1) {
                ...
                var url = '{{ route("language.update", ":id") }}';
                ...
                $.ajax({
                    ...
                    success: function(resp) {
                        ...
                        get_responce_message(resp, 'edit_language', '{{ route("language.index") }}');
                    },
                    error: function(XMLHttpRequest, textStatus, errorThrown) {
                        $("#dvloader").hide();
                        toastr.error(errorThrown.msg, 'failed');
